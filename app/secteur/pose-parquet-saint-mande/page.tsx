...
const poseparquetSaintMandConfig = {
  // SEO et métadonnées
  title: "Pose parquet Saint-Mandé – Bati France",
  description: "Parqueteur professionnel Saint-Mandé. Pose parquet massif et Pose parquet contrecollé. Devis gratuit.",
  keywords: [
    "pose parquet Saint-Mandé",
    "pose parquet Saint-Mandé",
    "pose parquet appartement Saint-Mandé",
    "pose parquet massif Saint-Mandé",
    "pose parquet contrecollé Saint-Mandé",
    "devis pose parquet Saint-Mandé",
    "entreprise pose parquet Saint-Mandé",
    "artisan pose parquet Saint-Mandé",
    "travaux pose parquet Saint-Mandé"
  ],
  ...
  heroTitle: "Pose parquet Saint-Mandé",
  heroSubtitle: "Parqueteur professionnel à Saint-Mandé. Pose parquet massif, Pose parquet contrecollé avec finitions expertes.",
  
  // Localisation
  location: "Saint-Mandé",
  
  // Description détaillée
  mainDescription: "Bati France et votre spécialiste pose parquet à Saint-Mandé. Nous maîtrisons tous les aspects de la pose parquet avec un savoir-faire artisanal reconnu. Notre expertise locale nous permet d'adapter nos interventions aux spécificités architecturales de Saint-Mandé, en respectant le caractère de chaque quartier.",
  ...
  // Avantages
  advantages: [
    "Expert pose parquet Saint-Mandé",
  ...
  projectExamples: [
    {
      title: "Pose parquet appartement Saint-Mandé",
    ...
    {
      title: "Pose parquet maison Saint-Mandé",
    ...
    {
      title: "Pose parquet rénovation Saint-Mandé",
...
export const metadata: Metadata = generateSectorMetadata(
  "Pose parquet " + poseparquetSaintMandConfig.sectorName,
  poseparquetSaintMandConfig.location,
  poseparquetSaintMandConfig.description,
  poseparquetSaintMandConfig.keywords
);

export default function PoseparquetSaintMandPage() {
  return <SectorPage {...poseparquetSaintMandConfig} />;
}