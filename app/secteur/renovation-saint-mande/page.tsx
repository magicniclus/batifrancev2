...
const renovationSaintMandConfig = {
  // SEO et métadonnées
  title: "Rénovation Saint-Mandé – Bati France",
  description: "Spécialiste rénovation tous corps d'état Saint-Mandé. Rénovation complète d'appartements et Rénovation énergétique. Devis gratuit.",
  keywords: [
    "renovation Saint-Mandé",
    "rénovation Saint-Mandé",
    "renovation appartement Saint-Mandé",
    "rénovation complète d'appartements Saint-Mandé",
    "rénovation énergétique Saint-Mandé",
    "devis renovation Saint-Mandé",
    "entreprise renovation Saint-Mandé",
    "artisan renovation Saint-Mandé",
    "travaux renovation Saint-Mandé"
  ],
  ...
  heroTitle: "Rénovation Saint-Mandé",
  heroSubtitle: "Spécialiste rénovation tous corps d'état à Saint-Mandé. Rénovation complète d'appartements, Rénovation énergétique avec finitions expertes.",
  
  // Localisation
  location: "Saint-Mandé",
  
  // Description détaillée
  mainDescription: "Bati France et votre spécialiste rénovation à Saint-Mandé. Nous maîtrisons tous les aspects de la rénovation avec un savoir-faire artisanal reconnu. Notre expertise locale nous permet d'adapter nos interventions aux spécificités architecturales de Saint-Mandé, en respectant le caractère de chaque quartier.",
  ...
  projectExamples: [
    {
      title: "Rénovation appartement Saint-Mandé",
    ...
    {
      title: "Rénovation maison Saint-Mandé",
    ...
    {
      title: "Rénovation rénovation Saint-Mandé",
...
export const metadata: Metadata = generateSectorMetadata(
  "Rénovation " + renovationSaintMandConfig.sectorName,
  renovationSaintMandConfig.location,
  renovationSaintMandConfig.description,
  renovationSaintMandConfig.keywords
);

export default function RénovationSaintMandPage() {
  return <SectorPage {...renovationSaintMandConfig} />;
}