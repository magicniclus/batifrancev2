...
const renovationPantinConfig = {
  // SEO et métadonnées
  title: "Rénovation Pantin – Bati France",
  description: "Spécialiste rénovation tous corps d'état Pantin. Rénovation complète d'appartements et Rénovation énergétique. Devis gratuit.",
  keywords: [
    "renovation Pantin",
    "rénovation Pantin",
    "renovation appartement Pantin",
    "rénovation complète d'appartements Pantin",
    "rénovation énergétique Pantin",
    "devis renovation Pantin",
    "entreprise renovation Pantin",
    "artisan renovation Pantin",
    "travaux renovation Pantin"
  ],
  
  // Contenu principal
  sectorName: "Pantin",
  heroImage: "https://images.unsplash.com/photo-1484154218962-a197022b5858?ixlib=rb-4.0.3&auto=format&fit=crop&w=2074&q=80",
  heroTitle: "Rénovation Pantin",
  heroSubtitle: "Spécialiste rénovation tous corps d'état à Pantin. Rénovation complète d'appartements, Rénovation énergétique avec finitions expertes.",
  
  // Localisation
  location: "Pantin",
  
  // Description détaillée
  mainDescription: "Bati France et votre spécialiste rénovation à Pantin. Nous maîtrisons tous les aspects de la rénovation avec un savoir-faire artisanal reconnu. Notre expertise locale nous permet d'adapter nos interventions aux spécificités architecturales de Pantin, en respectant le caractère de chaque quartier.",
  ...
  projectExamples: [
    {
      title: "Rénovation appartement Pantin",
    ...
    {
      title: "Rénovation maison Pantin",
    ...
    {
      title: "Rénovation rénovation Pantin",
...
export const metadata: Metadata = generateSectorMetadata(
  "Rénovation " + renovationPantinConfig.sectorName,
  renovationPantinConfig.location,
  renovationPantinConfig.description,
  renovationPantinConfig.keywords
);

export default function RénovationPantinPage() {
  return <SectorPage {...renovationPantinConfig} />;
}