...
const peinturePantinConfig = {
  // SEO et métadonnées
  title: "Peinture Pantin – Bati France",
  description: "Peintre professionnel Pantin. Peinture intérieure et Peinture extérieure. Devis gratuit.",
  keywords: [
    "peinture Pantin",
    "peinture Pantin",
    "peinture appartement Pantin",
    "peinture intérieure Pantin",
    "peinture extérieure Pantin",
    "devis peinture Pantin",
    "entreprise peinture Pantin",
    "artisan peinture Pantin",
    "travaux peinture Pantin"
  ],
  
  // Contenu principal
  sectorName: "Pantin",
  heroImage: "https://images.unsplash.com/photo-1562259949-e8e7689d7828?ixlib=rb-4.0.3&auto=format&fit=crop&w=2074&q=80",
  heroTitle: "Peinture Pantin",
  heroSubtitle: "Peintre professionnel à Pantin. Peinture intérieure, Peinture extérieure avec finitions expertes.",
  
  // Localisation
  location: "Pantin",
  
  // Description détaillée
  mainDescription: "Bati France et votre spécialiste peinture à Pantin. Nous maîtrisons tous les aspects de la peinture avec un savoir-faire artisanal reconnu. Notre expertise locale nous permet d'adapter nos interventions aux spécificités architecturales de Pantin, en respectant le caractère de chaque quartier.",
  ...
  projectExamples: [
    {
      title: "Peinture appartement Pantin",
    ...
    {
      title: "Peinture rénovation Pantin",
...
export const metadata: Metadata = generateSectorMetadata(
  "Peinture " + peinturePantinConfig.sectorName,
  peinturePantinConfig.location,
  peinturePantinConfig.description,
  peinturePantinConfig.keywords
);

export default function PeinturePantinPage() {
  return <SectorPage {...peinturePantinConfig} />;
}