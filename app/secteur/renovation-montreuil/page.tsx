...
const renovationMontreuilConfig = {
  // SEO et métadonnées
  title: "Rénovation Montreuil – Bati France",
  description: "Spécialiste rénovation tous corps d'état Montreuil. Rénovation complète d'appartements et Rénovation énergétique. Devis gratuit.",
  keywords: [
    "renovation Montreuil",
    "rénovation Montreuil",
    "renovation appartement Montreuil",
    "rénovation complète d'appartements Montreuil",
    "rénovation énergétique Montreuil",
    "devis renovation Montreuil",
    "entreprise renovation Montreuil",
    "artisan renovation Montreuil",
    "travaux renovation Montreuil"
  ],
  ...
  heroTitle: "Rénovation Montreuil",
  heroSubtitle: "Spécialiste rénovation tous corps d'état à Montreuil. Rénovation complète d'appartements, Rénovation énergétique avec finitions expertes.",
  
  // Localisation
  location: "Montreuil",
  
  // Description détaillée
  mainDescription: "Bati France et votre spécialiste rénovation à Montreuil. Nous maîtrisons tous les aspects de la rénovation avec un savoir-faire artisanal reconnu. Notre expertise locale nous permet d'adapter nos interventions aux spécificités architecturales de Montreuil, en respectant le caractère de chaque quartier.",
  ...
  projectExamples: [
    {
      title: "Rénovation appartement Montreuil",
    ...
    {
      title: "Rénovation maison Montreuil",
    ...
    {
      title: "Rénovation rénovation Montreuil",
...
export const metadata: Metadata = generateSectorMetadata(
  "Rénovation " + renovationMontreuilConfig.sectorName,
  renovationMontreuilConfig.location,
  renovationMontreuilConfig.description,
  renovationMontreuilConfig.keywords
);

export default function RénovationMontreuilPage() {
  return <SectorPage {...renovationMontreuilConfig} />;
}